...
import {
    ...
    paintObjectList, menuAddPaintShape, menuMovePaintShapeDown, menuMovePaintShapeUp, menuRemoveCurrentPaintShape
} from "./menu.js";
...
function newDrawing() { //clears canvas and prepares new drawing
